...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<HttpResponse<LogoutResponseDto>> logout(String token) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      _setStreamType<HttpResponse<LogoutResponseDto>>(
    ...
    final value = LogoutResponseDto.fromJson(_result.data!);
  ...
  Future<HttpResponse<MyOrderResponse>> getAllOrders({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
      _setStreamType<HttpResponse<MyOrderResponse>>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(
              _dio.options,
    ...
    final value = MyOrderResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
