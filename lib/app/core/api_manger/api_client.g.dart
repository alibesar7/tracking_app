...
class _ApiClient implements ApiClient {
  ...
  Future<HttpResponse<VerifyresetResponse>> verifyResetCode(
      VerifyResetRequest request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<VerifyresetResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<ChangePasswordDto>> changePassword(
    ...
    _data.addAll(body);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ChangePasswordDto>>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<VehiclesResponse>> getAllVehicle() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<VehiclesResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
