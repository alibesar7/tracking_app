...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i511.TrackOrderRemoteDataSource>(
      () => _i1007.TrackOrderRemoteDataSourceImpl(
        gh<_i974.FirebaseFirestore>(),
        gh<_i603.AuthStorage>(),
      ),
    );
    gh.factory<_i329.UploadDriverFireDataUseCase>(
      () => _i329.UploadDriverFireDataUseCase(gh<_i974.FirebaseFirestore>()),
    );
    gh.factory<_i233.UploadOrderFireDataUseCase>(
      () => _i233.UploadOrderFireDataUseCase(gh<_i974.FirebaseFirestore>()),
    );
