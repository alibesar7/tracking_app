...
class EditDriverProfilePage extends StatelessWidget {
  final DriverModel? driver;
  const EditDriverProfilePage({super.key, this.driver});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            LocaleKeys.editDriverProfile.tr(),
        ...
        backgroundColor: Colors.white,
        body: EditDriverProfilePageBody(user: driver),
      ),
    );
  }
}
